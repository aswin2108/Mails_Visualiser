# Email Visualizer
[![license](https://img.shields.io/github/license/nhnent/tui.editor.svg)](https://github.com/aswin2108/Mails_Visualiser/blob/master/LICENSE)
...
In order not to overwhelm the gmane.org server, use: 
...
![image](https://user-images.githubusercontent.com/72661784/187502745-d93dcea4-b381-455b-b480-1d1cd4bb15ea.png)

- A screen shot of running the gmodel.py application to produce the index.sqlite database.
![image](https://user-images.githubusercontent.com/72661784/187507888-6826adee-aae2-4f6e-96ec-a61b8191291c.png)

- A screen shot of SQLiteBrowser showing messages in the index.sqlite database after the gmodel.py has executed.
![image](https://user-images.githubusercontent.com/72661784/187510709-3b87b4ca-d9d1-4689-a704-1275aad5062a.png)

- A screen shot of the `gbasic.py`(top 25 participant orgs) program to compute basic histogram data on the messages retrieved.
![image](https://user-images.githubusercontent.com/72661784/187510988-d8ceb264-4915-4835-9553-0c27621ecb3c.png)

- `gword.py` and `gline.py`
![image](https://user-images.githubusercontent.com/72661784/187511333-4654d2ca-03ae-4848-bca5-91dbc604719e.png)

## Visualization using D3.js
- A screen shot of word cloud visualization for the messages retrieved.
![image](https://user-images.githubusercontent.com/72661784/187511516-d519c8a9-67df-4dec-b3e6-7f8f91b07f2b.png)

- A screen shot of time line visualization for the messages retrieved.
![image](https://user-images.githubusercontent.com/72661784/187512644-32e0373b-5aa9-4ea4-a7b2-acef70dae0d2.png)

- Changed the gline.py program to show the message count by year instead of by month. Switched from a by-month to a by-year visualization by changing only a few lines in gline.py. The puzzle is to figure out the smallest change to accomplish the change.
![image](https://user-images.githubusercontent.com/72661784/187512439-1f68d3ed-de7d-49ca-b24f-c72057268fde.png)
